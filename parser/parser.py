...
def main():
    ...
    # discretize_input = pd.read_csv('../intermediate_datasets/14_credit_output_dataset_concatente_nextNode.csv')
    # dset_name = 'discretize_input'
    # target_columns = ['SeriousDlqin2yrs']
    # dset = discretize_input
    # used_ids = reset_vector()
    # path = '../models/15_discretize/discretize_input.soil'
    # DIFFERENCE = 0
    # CURRENT_DSET = ''
    # used_ids,DIFFERENCE,CURRENT_DSET = generate_file_with_cols_and_data(path, dset, dset_name, target_columns, id_columns, used_ids,DIFFERENCE, CURRENT_DSET)
    #
    # discretize_output = pd.read_csv('../intermediate_datasets/15_credit_output_dataset_discretize_ruleFilter.csv')
    # dset_name = 'discretize_output'
    # target_columns = ['SeriousDlqin2yrs']
    # dset = discretize_output
    # path = '../models/15_discretize/discretize_output.soil'
    # used_ids,DIFFERENCE,CURRENT_DSET = generate_file_with_cols_and_data(path, dset, dset_name, target_columns, id_columns, used_ids,DIFFERENCE, CURRENT_DSET)
